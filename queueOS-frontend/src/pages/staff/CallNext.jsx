        ...
        <div className="mb-8">
          ...
          <div className="space-y-3">
            {attendingQueue.map(q => (
              <div key={q.id} className="card py-4 px-4 border-2 border-secondary-200 bg-secondary-50 shadow-sm">
                ...
                <div className="flex gap-2">
                  <button 
                    onClick={() => handleAction('served', q.id)}
                  ...
                  <button 
                    onClick={() => handleAction('no-show', q.id)}
                    disabled={loadingAction === q.id}
      ...
      <div>
        ...
        <div className="space-y-3">
          {waitingQueue.map((q, idx) => (
            <div key={q.id} className="card py-3 px-4 flex items-center justify-between shadow-sm border border-slate-100">
              <div className="flex items-center gap-3">
              ...
              <button 
                onClick={() => handleAction('call', q.id)}
                disabled={loadingAction === q.id}
